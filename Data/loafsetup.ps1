...
start powershell ((Split-Path $MyInvocation.InvocationName) + ".\oraclechecker.ps1")
...
& ".\Update Office to Semi Annual Channel - 64bit.bat"
}

"3" {#Update office 32 bit
$ScriptPath = Split-Path $MyInvocation.InvocationName
& ".\Update Office to Semi Annual Channel.bat"
}
